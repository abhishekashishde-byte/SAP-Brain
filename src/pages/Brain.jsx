    ...
    <div style={{ display:'flex', height:'100vh', background:'#FAFAF8', fontFamily:"'DM Sans',sans-serif" }}>
      ...
      <div style={{
        ...
        <div style={{ padding:'20px 16px 14px', borderBottom:'1px solid #F0EDE5' }}>
          ...
          <button onClick={()=>setShowNewChat(true)} style={{
            ...
            boxShadow:'0 2px 10px rgba(200,80,192,0.25)',
            transition:'all 0.2s',
          }}
            onMouseEnter={e=>{ e.currentTarget.style.boxShadow='0 4px 16px rgba(200,80,192,0.35)'; e.currentTarget.style.transform='translateY(-1px)' }}
      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden', minWidth:0 }}>
        ...
        {showSummarise && activeConv && (
          <div style={{
            background:'#FDF4FF', borderBottom:'1px solid #E8D9A0',
            ...
            <div style={{ display:'flex', gap:8 }}>
              ...
              <button onClick={()=>setShowSummarise(false)} style={{
                padding:'5px 12px', background:'none', border:'1px solid #E8C8F0', borderRadius:8,
              ...
              <div style={{
                  ...
                  <div style={{ display:'flex', flexWrap:'wrap', gap:8, justifyContent:'center', maxWidth:480 }}>
                    {STARTERS[pendingTopic].map((s,i) => (
                      <div key={i} onClick={()=>setInput(s)} style={{
                        ...
                        onMouseEnter={e=>{ e.currentTarget.style.borderColor=gold; e.currentTarget.style.color='#1C1C1E'; e.currentTarget.style.background='#FDF4FF' }}
                ...
                {!pendingModule && (
                  <button onClick={()=>setShowNewChat(true)} style={{
                    ...
                    fontFamily:"'DM Sans',sans-serif",
                    boxShadow:'0 4px 16px rgba(200,80,192,0.25)',
              ...
              <>
                ...
                {isLoading && !isStreaming && (
                  <div style={{ display:'flex', gap:10, alignItems:'flex-start', marginBottom:20 }}>
                    <div style={{ width:32, height:32, flexShrink:0 }}><WaniLogo size={30}/></div>
        ...
        <div style={{
          ...
          <div style={{ maxWidth:740, margin:'0 auto' }}>
            <div style={{
              ...
              onFocusCapture={e=>{ e.currentTarget.style.borderColor=gold; e.currentTarget.style.boxShadow=`0 0 0 3px rgba(200,80,192,0.08)` }}
