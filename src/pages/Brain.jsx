      ...
      <div style={{
        ...
        <div style={{ padding:'20px 16px 14px', borderBottom:'1px solid #F0EDE5' }}>
          <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:16 }}>
            ...
            <span style={{ fontFamily:"'Playfair Display',serif", fontSize:18, fontWeight:600, background:goldGrad, WebkitBackgroundClip:'text', WebkitTextFillColor:'transparent' }}>SAP Brain</span>
          </div>
            ...
            {!activeConv && !isStreaming ? (
              <div style={{
                ...
                <div style={{ fontFamily:"'Playfair Display',serif", fontSize:26, fontWeight:600, color:'#1C1C1E', marginBottom:8 }}>
                  {pendingModule ? `${MODULE_META[pendingModule]?.label} · ${pendingTopic || pendingModule}` : 'SAP Brain'}
                </div>
              ...
              <>
                ...
                {isLoading && !isStreaming && (
                  <div style={{ display:'flex', gap:10, alignItems:'flex-start', marginBottom:20 }}>
                    <div style={{ width:32, height:32, borderRadius:10, background:goldGrad, display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, fontWeight:700, color:'#fff', flexShrink:0, boxShadow:'0 2px 8px rgba(184,150,12,0.25)' }}>S4</div>
